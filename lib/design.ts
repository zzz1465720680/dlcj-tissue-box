...
export const PALETTE=[{name:'珍珠白',hex:'#eee9df'},{name:'曜石黑',hex:'#25292b'},{name:'岩石灰',hex:'#828786'},{name:'马鞍棕',hex:'#95694d'},{name:'焦糖橙',hex:'#d47939'},{name:'酒红',hex:'#802f3d'},{name:'松石绿',hex:'#416e63'},{name:'雾蓝',hex:'#87a9bc'},{name:'胭脂粉',hex:'#cf9b9d'},{name:'柠檬黄',hex:'#dfc457'},{name:'深海蓝',hex:'#344b65'},{name:'草木绿',hex:'#95b04f'}];
const surface=(color:string,perforated=false):Surface=>({color,material:'grain',perforated,edge:'#afc33e',thread:'#dfded5',art:[]});
export function initialDesign():Design{return {version:1,name:'我的第一款设计',parts:{body:surface('#eee9df'),corner0:surface('#eee9df',true),corner1:surface('#eee9df',true),corner2:surface('#eee9df',true),corner3:surface('#eee9df',true),trim:surface('#eee9df',true)},label:{enabled:true,color:'#222c28',ink:'#eee9df',text:'DLCJ'}};}
